...
public class FauxLeaguesHelper extends ComplexStateQuestHelper
{
	...
	public QuestStep loadStep()
	{
		...
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 18, "MOO"), openleaguesmenu);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 19, "Complete the Leagues Tutorial"), completeleaguestutorial);
		section1Task.addStep(claimfirstrelic.getSidebarManualSkipRequirement(), claimfirstrelic);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 8, "Turn off your run"), togglerunenergy);
		section1Task.addStep(new Conditions(LogicType.AND, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 22, "Pickpocket a Citizen"), new SkillRequirement(Skill.THIEVING, 5, true)), pickpocketcitizen);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 0, "Pet Renu"), petrenu);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 10, "Bow near a quetzal"), bownearrenu);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 12, "Travel using the Quetzal Transport System"), travelwithrenu);
		section1Task.addStep(travelbackwithrenu.getSidebarManualSkipRequirement(), travelbackwithrenu);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 27, "Fill something up from a water pump"), usewaterpump);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 4, "Attack a dummy"), attackdummy);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 14, "Cry near a child"), crynearachild);
		section1Task.addStep(new Conditions(LogicType.AND, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 4, "Steal some bread"), cake.quantity(14).alsoCheckBank()), stealcakesfrombakersstall);
		section1Task.addStep(new Conditions(LogicType.AND, chisel.alsoCheckBank(), knife), tradeshopkeeper);
		section1Task.addStep(new Conditions(LogicType.AND, brownApron, redCape), tradefloria);
		section1Task.addStep(new Conditions(LogicType.AND, brownApron.equipped(), redCape.equipped()), equipapronandredcape);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 28, "Defeat a Rat"), attackratlevel1);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 4, "Salute next to a statue of Quoatlos"), salutequoatlos);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 3, "Activate a prayer near an altar"), useprayernearshrineofralos);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 1, "Pet Xolo in Civitas"), petxolo);
		section1Task.addStep(new Conditions(LogicType.OR, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_36, true, 24, "150 Combat Achievements"), new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 23, "Drink from a bird bath")), drinkfrombirdbath);
		section1Task.addStep(new Conditions(LogicType.AND, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 14, "Chop Some Logs"), logs.quantity(2).alsoCheckBank()), chopdowntree);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 6, "Burn Some Normal Logs"), burnlog);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 8, "Fletch Some Arrow Shafts"), fletchlog);
		section1Task.addStep(useeastcivitasbank.getSidebarManualSkipRequirement(), useeastcivitasbank);
		section1Task.addStep(and(shears.alsoCheckBank(), glassblowingPipe.alsoCheckBank()), tradeartima);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 9, "Talk to a Gladiator"), talktogladiator);
		section1Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 6, "Talk to any Port master"), talktoportmaster);
		section1Task.addStep(and(bucketOfSand.quantity(10), sodaAsh.quantity(10)), talktotradercrewmember);
		section1Task.addStep(moltenGlass.quantity(10), usefurnace);
		section1Task.addStep(and(moltenGlass.quantity(10).alsoCheckBank(), not(moltenGlass.quantity(1))), depositmoltenglass);
		section1Task.addStep(and(bucketOfSand.quantity(10).alsoCheckBank(), sodaAsh.quantity(10).alsoCheckBank(), moltenGlass.quantity(10).alsoCheckBank()), talktotradercrewmember2);
		section1Task.addStep(moltenGlass.quantity(20).alsoCheckBank(), usefurnace2);
		section1Task.addStep(new SkillRequirement(Skill.CRAFTING, 20, true), blowglassintooillanterns);

		section2Task = new ConditionalStep(this, eatcookedrabbit);
		section2Task.addStep(new Conditions(LogicType.OR, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 21, "Pick 6 wheat, 6 cabbages and 6 potatoes"), new VarbitRequirement(20372, 6)), pickcabbage);
		section2Task.addStep(new Conditions(LogicType.AND, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 25, "Defeat a Chicken"), bones), attackchickenlevel1);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 7, "Sit near a stolen cabbage"), sitwithdogs);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 7, "Feed a dog some bones"), feedbonestomolossus);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 3, "Pick some Sweetcorn from a Field"), picksweetcorn);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 2, "Eat an Onion"), pickandeatonion);
		section2Task.addStep(new VarbitRequirement(20371, 6), pickwheat);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_10, true, 26, "Make some Flour"), emptyflourbin);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 21, "Pick 6 wheat, 6 cabbages and 6 potatoes"), pickpotato);
		section2Task.addStep(rake, tradeharminia);
		section2Task.addStep(new Conditions(LogicType.OR, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_22, true, 24, "200 Collection log slots"), new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 26, "Rake a Flower Patch")), rakeflowerpatch);
		section2Task.addStep(bucket, emptywaterbucket);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 30, "Milk a Buffalo"), milkdairybuffalo);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 6, "Shear an Alpaca"), shearalpaca);
		section2Task.addStep(zanarisfairyring.getSidebarManualSkipRequirement(), zanarisfairyring);
		section2Task.addStep(new Conditions(LogicType.AND, cowhide, bones), attackcowlevel2);
		section2Task.addStep(burybones.getSidebarManualSkipRequirement(), burybones);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 11, "Travel to Aldarin via Fairy ring"), aldarinfairyring);
		var grapeDone = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_13, true, 9, "Fill a Grape Barrel for the Foreman");
		section2Task.addStep(or(grapeDone, new ItemRequirement("Barrel", 30037)), talktovineyardforeman);
		section2Task.addStep(or(grapeDone, new ChatMessageRequirement("<col=06600c>Your grape barrel is now full. You should return it to the Vineyard foreman.</col>")), collectshimmeringgrapes);
		section2Task.addStep(grapeDone, returntovineyardforeman);
		section2Task.addStep(new Conditions(LogicType.AND, coins.quantity(100), chisel), withdrawaldarinbanker);
		section2Task.addStep(coins.quantity(50001).alsoCheckBank(), tradetoci);
		section2Task.addStep(cutextragems.getSidebarManualSkipRequirement(), cutextragems);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 18, "Defeat a Seagull"), attackseagulllevel2);
		section2Task.addStep(and(tyrasHelm, bucket, rawRabbit.quantity(5)), tradechartership);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 21, "Cook something with an apron"), cookrabbitonoven);
		section2Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 1), eatcookedrabbit);


		section3Task = new ConditionalStep(this, talktopicaria);
		section3Task.addStep(talktoantonia.getSidebarManualSkipRequirement(), talktoantonia);
		section3Task.addStep(or(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 11, "Light a Torch"), unlitTorch), buytorch);
		section3Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 11, "Light a Torch"), lighttorch);
		section3Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 26, "Fill bucket of sand"), fillabucketwithsand);
		section3Task.addStep(and(feathers.quantity(1000), bigFishingNet), talktopicaria);
		...
		section4Task.addStep(charterDone, chartertocivitas);
		section4Task.addStep(buypineapples.getSidebarManualSkipRequirement(), buypineapples);
		section4Task.addStep(depositpineapples.getSidebarManualSkipRequirement(), depositpineapples);
		section4Task.addStep(ironMace, buyironmace);
		section4Task.addStep(ironMace.equipped(), getEquipironmace());
		section4Task.addStep(new Conditions(LogicType.AND, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 17, "Obtain a Casket from Fishing"), new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_11, true, 3, "Obtain an old boot from a fishing spot"), new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_13, true, 10, "Fish a House Key")), castfishingspot);
		section4Task.addStep(new Conditions(LogicType.AND, jugOfWine, stew, moonLite, cupOfTea), talktobartender);
		section4Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 24, "Drink some moon-lite"), drinkmoonlite);
		section4Task.addStep(drinkjugofwine.getSidebarManualSkipRequirement(), drinkjugofwine);
		section4Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_11, true, 29, "Successfully pickpocket a Citizen 10 times in a row"), pickpocketcitizenuntilsuccess);
		section4Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 25, "Purchase a Player Owned House"), buypoh);
		section4Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 28, "Sell some silk to a silk trader"), tradesilkmerchant);
		section4Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 28), givestewtooli);

		section5Task = new ConditionalStep(this, talktofriendlyforester);
		section5Task.addStep(traveltoauburnvale.getSidebarManualSkipRequirement(), traveltoauburnvale);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 22), drinkcupoftea);
		section5Task.addStep(depositinauburnvale.getSidebarManualSkipRequirement(), depositinauburnvale);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 5), tradesebamo);
		section5Task.addStep(tradelunami.getSidebarManualSkipRequirement(), tradelunami);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 15, "Chop using steel axe"), chopdowndeadtree);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 7, "Turn any Logs Into a Plank"), makeplankatsawmill);
		var leathChapsMade = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 22, "Craft Leather chaps");
		section5Task.addStep(or(leathChapsMade, leather), tanleatheratchouani);
		section5Task.addStep(or(leathChapsMade, and(needle, thread)), tradeauburnvaleshopkeeper);
		section5Task.addStep(leathChapsMade, craftleatherchaps);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 9, "Admire some beautiful scenery"), admirebeautifullog);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 8, "Step onto an Ent trail"), steponenttrail);
		section5Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 20, "Pick 6 flax"), pickflax);
		section5Task.addStep(new Conditions(LogicType.AND,
		...
		section5Task.addStep(forestryKit.equipped(), talktofriendlyforester);


		section6Task = new ConditionalStep(this, buyfishfrompicaria);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 10, "Travel by canoe"), traveltotalteklan);
		section6Task.addStep(depositintalteklan.getSidebarManualSkipRequirement(), depositintalteklan);
		section6Task.addStep(tradeteicuh.getSidebarManualSkipRequirement(), tradeteicuh);
		var dyedCapePurple = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 0, "Dye a cape Purple");
		section6Task.addStep(new Conditions(LogicType.OR, dyedCapePurple, purpleDye), tradexochitl);
		section6Task.addStep(dyedCapePurple, dyecape);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 15, "Dance near a bard"), dancenearabard);
		section6Task.addStep(new Conditions(LogicType.AND, shortbow, ironArrow.quantity(10)), tradearcuani);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 26, "Kill frog"), attackfroglevel5);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 12, "Tree in Tlati Rainforest"), chopdowndeadtreerainforest);
		section6Task.addStep(traveltokastori.getSidebarManualSkipRequirement(), traveltokastori);
		section6Task.addStep(new Conditions(LogicType.AND, smallFishingNet, fishingRod, fishingBait.quantity(50), lobsterPot, flyFishingRod, harpoon), tradesulisal);
		section6Task.addStep(sardinefishingspot.getSidebarManualSkipRequirement(), sardinefishingspot);
		section6Task.addStep(cooksardinesatoven.getSidebarManualSkipRequirement(), cooksardinesatoven);
		section6Task.addStep(new Conditions(LogicType.AND, new SkillRequirement(Skill.FISHING, 10, true), rawShrimps, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 12, "Catch a Shrimp")), shrimpfishingspot);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 20, "Cook Shrimp"), cookshrimpatoven);
		section6Task.addStep(new SkillRequirement(Skill.FISHING, 15, true), herringfishingspot);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 13, "Catch an Anchovy"), anchovyfishingspot);
		var impBasement = new ZoneRequirement(new Zone(new WorldPoint(1375, 9449, 0), new WorldPoint(1387, 9457, 0)));
		section6Task.addStep(impBasement, climbdownladder);
		...
		section6Task.addStep(and(fiendishAshes, killedImpWithEarth, killedImpInBasement), attackimplevel2);
		section6Task.addStep(not(impBasement), climbupladder);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 2, "Pet a Caique"), petcaique);
		section6Task.addStep(new VarbitRequirement(VarbitID.PENDANT_OF_ATES_TLATI_FOUND, 1), activatestatuekastori);
		section6Task.addStep(new Conditions(LogicType.AND, new SkillRequirement(Skill.ATTACK, 20, false), new SkillRequirement(Skill.MAGIC, 21, false), new SkillRequirement(Skill.DEFENCE, 5, false)), attackgemstonecrablevel160);
		var witnessCrabDie = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_3, true, 14, "See gemstone crab burrow");
		section6Task.addStep(witnessCrabDie, witnessthegemcrabsdefeat);
		section6Task.addStep(travelgloomthorn.getSidebarManualSkipRequirement(), travelgloomthorn);
		section6Task.addStep(new VarbitRequirement(VarbitID.PENDANT_OF_ATES_AUBURN_FOUND, 1), activatestatuenemus);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 20, "Defeat an Icefiend in Varlamore"), attackicefiendlevel13);
		section6Task.addStep(new VarbitRequirement(VarbitID.PENDANT_OF_ATES_DARKFROST_FOUND, 1), activatestatuedarkfrost);
		section6Task.addStep(ironMace.equipped(), equipironmace2);
		...
		section6Task.addStep(and(killed5Bunnies, killed5ThingsWithMace), attackrabbitlevel2);
		section6Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 9, "Cast Home Teleport"), hometeleport);
		var agility666 = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_13, true, 14, "666 jumps");
		section6Task.addStep(agility666, yamaagility);
		section6Task.addStep(not(new ZoneRequirement(new Zone(new WorldPoint(1463, 5566, 0), new WorldPoint(1546, 5644, 0)))), returntocivitas);
		section6Task.addStep(new ZoneRequirement(new Zone(new WorldPoint(1277, 2834, 0), new WorldPoint(1492, 3002, 0))), travelaldarin);
		section6Task.addStep(tyrasHelm.equipped(), withdrawtyrashelm);
		section6Task.addStep(new Conditions(LogicType.AND, chisel, coins), withdrawaldarinbanker2);
		section6Task.addStep(new ObjectCondition(15314) /* Door make object */, enterportal);
		var builtRoom = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_7, true, 10);
		section6Task.addStep(builtRoom, buildroom);
		section6Task.addStep(not(new ObjectCondition(15314)) /* Door make object */, exitportal);
		section6Task.addStep(new SkillRequirement(Skill.CRAFTING, 70, false), tradetociagain);
		section6Task.addStep(not(new ZoneRequirement(new Zone(new WorldPoint(1277, 2834, 0), new WorldPoint(1492, 3002, 0)))), talktoantonia2);
		section6Task.addStep(and(new ItemRequirement("Bronze full helm", ItemID.BRONZE_FULL_HELM), new ItemRequirement("Adamant full helm", ItemID.ADAMANT_FULL_HELM)), tradethurid);
		section6Task.addStep(and(
		...
		section7Task.addStep(inCamTorum, entercamtorum);
		section7Task.addStep(
		...
		section7Task.addStep(gotRunes, tradenahta);
		var castLowAlch = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_7, true, 17);
		section7Task.addStep(castLowAlch, lowalchrunes);
		section7Task.addStep(bigFishingNet, depositcamtorumbanker);
		section7Task.addStep(jugOfWine.quantity(5), tradecamtorumbartender);
		var equipIronDagger = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 6);
		section7Task.addStep(equipIronDagger, tradecamtorumblacksmith);

		section8Task = new ConditionalStep(this, exitthiefsden);
		section8Task.addStep(not(inCamTorum), leaguemenuteleport);
		var equippedMithWeapon = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_9, true, 8);
		section8Task.addStep(new Conditions(LogicType.AND, adamantPlatebody, adamantPlatelegs, bronzePlatelegs, bronzePlatebody, mithrilSpear, steelPlatebody), tradefortisblacksmith);
		section8Task.addStep(equippedMithWeapon, equipmithrilspear);
		var lowAlched500gp = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_8, true, 19);
		section8Task.addStep(lowAlched500gp, lowalchsteelplatebody);
		section8Task.addStep(depositfortiswestbank.getSidebarManualSkipRequirement(), depositfortiswestbank);
		...
		section8Task.addStep(or(inGuardBasement, killedGuard), enterguardbunker);
		section8Task.addStep(killedGuard, attackguardlevel21);
		section8Task.addStep(not(inGuardBasement), exitguardbunker);
		...
		section8Task.addStep(or(inThiefDen, and(killedThief, exitDen)), enterthiefsden);
		section8Task.addStep(killedThief, attackthieflevel16);
		section8Task.addStep(exitDen, exitthiefsden);
		...
		section9Task.addStep(or(bucketOfMilk, churnedButter), milkdairybuffalo2);
		section9Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 16, "Defeat a Buffalo"), attackbuffalolevel9);
		section9Task.addStep(churnedButter, churndairychurn);
		var madeButterPotato = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_7, true, 16, "Butter a potato");
		section9Task.addStep(or(potato, madeButterPotato), pickpotato2);
		section9Task.addStep(or(bakedPotato, madeButterPotato), cookfarmingpatchoven);
		section9Task.addStep(madeButterPotato, combinebutterwithpotato);
		var compostFull = new VarbitRequirement(VarbitID.FARMING_TRANSMIT_E2, 5, Operation.GREATER_EQUAL);
		section9Task.addStep(compostFull, fillcompostbin);
		...
		section9Task.addStep(or(plantedPotatoSeeds, potatoSeed.quantity(3)), pickpocketmasterfarmer);
		var protectedCrops = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 24, "Protect Your Crops");
		section9Task.addStep(or(protectedCrops, new Conditions(LogicType.AND, rake, seedDibber, compost.quantity(2))), buyseeddibberharminia);
		section9Task.addStep(or(new VarbitRequirement(VarbitID.FARMING_TRANSMIT_B1, 3, Operation.GREATER_EQUAL), plantedPotatoSeeds), rakeallotment);
		section9Task.addStep(plantedPotatoSeeds, plantpotatoseeds);
		section9Task.addStep(protectedCrops, payprotectharminia);
		section9Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_12, true, 24, "Defeat a Dire Wolf"), attackdirewolflevel88);
		section9Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_9, true, 0, "Defeat a Scorpion with a Mithril Spear"), attackscorpionlevel14);
		section9Task.addStep(copperOre, minecopperrocks);

		section9Task.addStep(new Conditions(LogicType.AND, new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 13, "Mine 5 Tin Ore"), new SkillRequirement(Skill.MINING, 15, true)), minetinrocks);
		section9Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_12, true, 25, null), attackjaguarlevel67);
		section9Task.addStep(new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_0, true, 27, "Defeat a Hill Giant"), attackhillgiantlevel28);
		var minedClay = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_1, true, 14);
		section9Task.addStep(minedClay, mineclayrocks);
		var minedIron = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_10, true, 28);
		section9Task.addStep(minedIron, mineironrocks);
		var mineSilver = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_10, true, 27);
		section9Task.addStep(mineSilver, minesilverrocks);
		var minedCoal = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_2, true, 31);
		section9Task.addStep(minedCoal, minecoalrocks);
		section9Task.addStep(minegoldrocks.getSidebarManualSkipRequirement(), minegoldrocks);
		section9Task.addStep(new SkillRequirement(Skill.MINING, 55), minemoreiron);
		var minedMithril = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_10, true, 29);
		section9Task.addStep(minedMithril, minemithrilrocks);
		var fishedMackrel = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_7, true, 22);
		section9Task.addStep(fishedMackrel, bignetcoastfishingspot);
		var fishedCod = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_7, true, 19);
		section9Task.addStep(fishedCod, bignetcoastfishingspotcod);

		var killedOryx = new VarplayerRequirement(VarPlayerID.LEAGUE_TASK_COMPLETED_12, true, 26);
		section9Task.addStep(killedOryx, attackoryxlevel15);
		...
		section10Task.addStep(or(madePottery, and(tiaraMould.alsoCheckBank(), ringMould.alsoCheckBank(), amuletMould.alsoCheckBank())), buymouldsartima);
		section10Task.addStep(or(madePottery, softClay), softclayspawn);
		...
		section10Task.addStep(or(unfiredItem, madePottery), usepotterswheel);
		section10Task.addStep(madePottery, firepotteryoven);
